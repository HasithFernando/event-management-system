...
import { Search, Edit2, Calendar, MapPin, Users, Plus } from "lucide-react";
...
export function EventList({ events, userRole, onCreateClick, onBuyTickets, onEditEvent }: EventListProps) {
              ...
              <div className="mt-5 pt-4 border-t border-gray-100 flex justify-between items-center">
                {isOrganizer ? (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-indigo-50 hover:text-indigo-700 text-gray-700 text-sm font-medium rounded-lg transition-colors"
                  >
