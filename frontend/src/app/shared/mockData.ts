...
export const STATS = [
  { label: "Total Revenue", value: "LKR 425,800", icon: DollarSign, trend: "+12.5%", color: "text-green-500" },
  ...
  { label: "Avg. Ticket Price", value: "LKR 185", icon: TrendingUp, trend: "-2.1%", color: "text-orange-500" },
];
